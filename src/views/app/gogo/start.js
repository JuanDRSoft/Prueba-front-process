...
const orderOptions = [
  { column: '', label: 'Fecha Actualización' },
...
const DataListPages = ({ match, authUser }) => {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [selectedPageSize, currentPage, selectedOrderOption, search, reloadData]);
...
export default injectIntl(connect(mapStateToProps, {})(DataListPages));
